...
// Mendapatkan elemen dengan ID "tampilan-waktu"
var tampilanWaktu = document.getElementById("tampilan-waktu");

// Mendapatkan data waktu dari atribut "data-waktu" pada elemen "tampilan-waktu"
var waktuTarget = tampilanWaktu.getAttribute("data-waktu");

// Menghitung selisih waktu antara waktu saat ini dan waktu target
var selisihWaktu = new Date(waktuTarget) - new Date();
...
var interval = setInterval(function() {
  ...
  // Menampilkan waktu yang tersisa pada elemen HTML
  ...
  // Mengurangi selisih waktu setiap detik
  selisihWaktu -= 1000;

  // Menghentikan countdown jika waktu target telah tercapai
  if (selisihWaktu < 0) {
    clearInterval(interval);
    tampilanWaktu.innerHTML = "Waktu telah habis";
  }
}, 1000);
